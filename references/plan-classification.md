...
- Warnings or pitfalls tied to a specific file/function -> inline code comment OR `AGENTS.md` note
...
4. Execute the externalization (write the memory, edit AGENTS.md, open the issue, etc.).
